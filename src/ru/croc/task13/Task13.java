...
public class Task13 {
    public static void main(String[] args) {
        ...
        KissCinema kissCinema = new KissCinema(moviesPath, filmsViews);
        ...
        User myFirstUser = new User(11, new HashSet<>(Arrays.asList(2, 4)));
        ...
        KissCinema kissCinema2 = new KissCinema(moviesPath, myFilmsViews);
        User mySecondUser = new User(12, new HashSet<>(Arrays.asList(10, 12)));
